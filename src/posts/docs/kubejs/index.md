...
- [方块涂抹配方](07_block_smear_recipe.md) - 使用上方方块涂抹下方方块
...
- [煮沸配方](17_boiling_recipe.md) - 在炼药锅环境进行煮沸处理
- [烹饪配方](18_cooking_recipe.md) - 在炼药锅环境进行加热烹饪
- [筛网配方](19_mesh_recipe.md) - 在筛网/脚手架环境下处理物品
- [概率矿物涌泉配方](20_mineral_fountain_chance_recipe.md) - 在指定维度按概率转换方块
