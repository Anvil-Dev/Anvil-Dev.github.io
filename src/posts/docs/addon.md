...
1. [环境搭建与模组构建](addon/01_environment.md) - 配置开发环境
2. [创建你的第一个物品](addon/02_create_item.md) - 学习基本的物品注册
3. [创建你的第一个方块](addon/03_create_block.md) - 学习基本的方块注册
...
准备好开始您的附属开发之旅了吗？让我们从[环境搭建](addon/01_environment.md)开始吧！
