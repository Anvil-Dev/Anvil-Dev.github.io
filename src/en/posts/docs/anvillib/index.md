...
**AnvilLib** is a NeoForge mod library developed by [Anvil Dev](https://github.com/Anvil-Dev), providing Minecraft (1.21.1) mod developers with a collection of practical tools and frameworks.
