...
The AnvilCraft development documentation provides comprehensive technical guidance for mod developers and content
creators, covering all aspects from add-on mod development to data pack customization.
...
- **System recipes**: multiblock conversion, mob transform with item, multiple-to-one smithing, frost smithing,
  charger/discharger, energy weapon make

Each recipe type includes JSON structure details and practical examples.

#### 3. [KubeJS Integration](kubejs/index.md)
...
documentation provides the guidance and technical references you need.
